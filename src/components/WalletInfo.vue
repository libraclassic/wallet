<template>
  <div class="wallet-container">
    <div class="card">
      <qrcode-vue class="qrcode" :value="userAddress" :size="size" background="#FFFFFF" level="H"/>
      <div class="address content">{{ userAddress }}</div>
      <div class="button-box">
        <b-button icon-left="content-copy" @click="copyAddress">复制地址</b-button>
      </div>
    </div>
  </div>
</template>
